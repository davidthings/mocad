...
module actHexShaft12Adapter0_25( p = 0, info = false ) {
  moPresent( positions, p, info )
    color( Steel )
      translate( [ 0, AdapterOffsetY, 0 ] )
          import("./stl/actobotics_hex_shaft_wheel_adapter_0_25.stl");
}

function actHexShaft12Adapter0_25Position( p = 0 ) = positions[ p ];

moMoveOriginTo( actHexShaft12Adapter0_25Position( 0 ) )
  actHexShaft12Adapter0_25( 0, info = true, $name = true  );
