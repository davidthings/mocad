...
module actHexShaft12Adapter4( p = 0, info = false ) {
  moPresent( positions, p, info )
    color( Steel )
      translate( [ 0, AdapterOffsetY, 0 ] )
          import("./stl/actobotics_hex_shaft_wheel_adapter_4.stl");
}

function actHexShaft12Adapter4Position( p = 0 ) = positions[ p ];

moMoveOriginTo( actHexShaft12Adapter4Position( 0 ) )
  actHexShaft12Adapter4( 0, info = true, $name = true  );
